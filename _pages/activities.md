...
- **FAIR** - provide theoretical and experimental evidence of the advantages of Integrative AI.
- **Innovaction** - a tool for simultaneous/streaming speech recognition and translation for courses;
- **Smurf4EU** - an Extreme Scale EuroHPC grant on Jupiter with the goal of creating a Suite of Multimodal Reasoning Foundation Models for Europe;
- **Meetween** - a project funded by the European Commission with the mission to build the AI-based technology solutions needed to power the next generation of video conferencing platforms;
...
- **Beomseok Lee** - PhD Co-Advisor (2023-2026)
